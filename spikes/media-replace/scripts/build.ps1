...
Write-Host "Host:  replace_host.exe [port=5902] [password=road-desk] [auto|mirror|gdi]"
Write-Host "Viewer: replace_viewer.exe host:port [password] [tls_sha256]"
Write-Host "Env: ROAD_DESK_PSK, ROAD_DESK_CAPTURE, ROAD_DESK_TLS_FINGERPRINT, ROAD_DESK_TLS_INSECURE=1"
