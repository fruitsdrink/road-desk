...
Write-Host "Tests: cmake --build build --target auth_test session_mutex_test mux_parse_test clipboard_test tls_test capture_strategy_test session_monitor_test && ctest --test-dir build"
